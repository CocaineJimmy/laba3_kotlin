...
fun MyScrollingScreen(modifier: Modifier = Modifier){
    Column(
        ...
        BookImage(R.drawable.ios_apprentice, R.string.name)
        BookImage(R.drawable.kotlin_aprentice, R.string.name)
        BookImage(R.drawable.swift_apprentice, R.string.name)
    }
}
